...
VALUES
  ('中尾　勇哉', 'kaihatsu.yuya.nakao@gmail.com'),
  ('ジャン　チェン', 'kaihatsu.chien.jan@gmail.com'),
  ('福嶋　ゆか', 'kaihatsu.yuka.fukushima@gmail.com'),
  ('ミン　ピャイ　テイン', 'kaihatsu.min.pyai.tein@gmail.com'),
  ('リク　ハン', 'kaihatsu.han.riku@gmail.com'),
  ('松井　孝典', 'kaihatsu.takanori.matsui@gmail.com'),
  ('藤井　奏多', 'kaihatsu.kanata.fujii@gmail.com'),
  ('及川　勇人', 'kaihatsu.yuto.oikawa@gmail.com'),
  ('飯田　英寛', 'kaihatsu.hidehiro.iida@gmail.com'),
  ('森　政勝', 'kaihatsu.masakatsu.mori@gmail.com'),
  ('中川　祐希', 'kaihatsu.yuki.nakagawa@gmail.com'),
  ('翁長　靖武', 'kaihatsu.yasutake.onaga@gmail.com'),
